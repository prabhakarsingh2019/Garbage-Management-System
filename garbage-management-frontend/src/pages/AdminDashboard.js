        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="mt-6">
              ...
              >
                View all bins<span className="sr-only"> Total bins</span>
              </Link>
            </div>
          </div>
        </div>
          ...
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="mt-6">
              <Link
                ...
                className="text-sm font-medium text-blue-600 hover:text-blue-500"
              >
                View all users<span className="sr-only"> Registered users</span>
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm font-medium text-gray-900">Add New Bin</p>
              <p className="text-sm text-gray-500 truncate">
                Register a new garbage bin
              </p>
            </div>
          </Link>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-500 truncate">
                Plan a garbage collection route
              </p>
            </div>
          </Link>
        </div>
